...
6. Inside the new `data` folder create 2 new folders. One named: **`minecraft`** and another named whater you wish. The name you choose for this folder will impact the way you execute functions in future. So keep it short and simple. examples: **`main`** or **`map`**. This is the folder where we'll be adding all of the `.mcfunction` files.
...
```
> Replace the `%` with the name of the folder you chose that effects your functions. (Provided examples were **`main`** or **`map`**)
