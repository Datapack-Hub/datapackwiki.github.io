...
Si vous débutez avec les packs de données, vous êtes au bon endroit. En regardant autour de vous, se lancer dans la création de packs de données peut sembler déroutant, mais une fois que vous aurez compris les bases, vous partirez du bon pied.
